...
echo "{\"name\":\"$PROJECT\",\"title\":\"$PROJECT\", \"database\": \"test\"}" | opal rest --opal https://localhost:8443 -u administrator -p $OPAL_ADMINISTRATOR_PASSWORD --content-type 'application/json' -m POST /projects
